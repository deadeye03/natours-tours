...
},{"./es6.array.iterator":"../../node_modules/core-js/modules/es6.array.iterator.js","./_object-keys":"../../node_modules/core-js/modules/_object-keys.js","./_redefine":"../../node_modules/core-js/modules/_redefine.js","./_global":"../../node_modules/core-js/modules/_global.js","./_hide":"../../node_modules/core-js/modules/_hide.js","./_iterators":"../../node_modules/core-js/modules/_iterators.js","./_wks":"../../node_modules/core-js/modules/_wks.js"}],"alerts.js":[function(require,module,exports) {
"use strict";
...
exports.signUp = exports.resetPassword = exports.newPassword = exports.logout = exports.login = void 0;
      ...
      while (1) switch (_context.prev = _context.next) {
        ...
        case 7:
          ...
          if (response.status === 'success') {
            ...
            (0, _alerts.showAlert)('error', 'incorrect email address or password');
          }
          _context.next = 15;
          break;
        case 12:
      ...
      while (1) switch (_context2.prev = _context2.next) {
        ...
        case 6:
          ...
          if (response.status === 'success') {
            ...
            (0, _alerts.showAlert)('error', 'Error During logout');
          }
          _context2.next = 14;
          break;
        case 11:
    ...
    return _regeneratorRuntime().wrap(function _callee3$(_context3) {
      while (1) switch (_context3.prev = _context3.next) {
        ...
        case 7:
          ...
          if (res.ok) {
            (0, _alerts.showAlert)('success', 'Account is created successfully');
            window.setTimeout(function () {
              location.assign('/login');
            }, 1500);
          } else if (response.error.code === 11000) {
            (0, _alerts.showAlert)('error', 'This email is already exit enter another email');
          } else {
            (0, _alerts.showAlert)('error', response.message.split(':')[2]);
          }
          _context3.next = 14;
          break;
        case 11:
    ...
    return _regeneratorRuntime().wrap(function _callee4$(_context4) {
      while (1) switch (_context4.prev = _context4.next) {
        ...
        case 7:
          ...
          if (res.ok) {
            (0, _alerts.showAlert)('success', 'Reset password request send to Email successfylly');
            window.setTimeout(function () {
              location.assign('/login');
            }, 2500);
          } else if (response.error.code === 11000) {
            ...
            response.message.split(':')[2] ? (0, _alerts.showAlert)('error', response.message.split(':')[2]) : (0, _alerts.showAlert)('error', response.message);
          }
          _context4.next = 14;
          break;
        case 11:
...
var newPassword = exports.newPassword = /*#__PURE__*/function () {
    ...
    return _regeneratorRuntime().wrap(function _callee5$(_context5) {
      while (1) switch (_context5.prev = _context5.next) {
        case 0:
          ...
          _context5.prev = 1;
          _context5.next = 4;
          return fetch("/api/v1/users/resetPassword/".concat(token), {
            method: 'PATCH',
            headers: {
              'Content-Type': 'application/json'
            },
  ...
  return function newPassword(_x5, _x6, _x7) {
    return _ref5.apply(this, arguments);
  };
}();
},{"./alerts":"alerts.js"}],"updatingUserData.js":[function(require,module,exports) {
"use strict";
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          ...
          _context.prev = 1;
          _context.next = 4;
          return fetch('/api/v1/users/updateMe', {
            method: 'PATCH',
            // headers: {
            //     'Content-Type': 'application/json'
            // },
        ...
        case 7:
          ...
          console.log(response);
          if (res.ok) {
            (0, _alerts.showAlert)('success', 'Data upadated successfully');
            window.setTimeout(function () {
              location.assign('/me');
            }, 1500);
          } else {
            response.message.split(':')[2] != undefined ? (0, _alerts.showAlert)('error', response.message.split(':')[2]) : (0, _alerts.showAlert)('error', response.message);
    ...
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        case 0:
          ...
          _context2.prev = 1;
          _context2.next = 4;
          return fetch('/api/v1/users/updateMyPassword', {
            method: 'PATCH',
            headers: {
              'Content-Type': 'application/json'
            },
        ...
        case 7:
          ...
          // console.log(response)
          if (res.ok) {
            (0, _alerts.showAlert)('success', 'Password upadated successfully');
            window.setTimeout(function () {
              location.assign('/me');
            }, 1000);
          } else {
            msg = response.message.split(':')[2];
            msg ? (0, _alerts.showAlert)('error', response.message.split(':')[2]) : (0, _alerts.showAlert)('error', response.message);
...
function asyncGeneratorStep(n, t, e, r, o, a, c) { try { var i = n[a](c), u = i.value; } catch (n) { return void e(n); } i.done ? t(u) : Promise.resolve(u).then(r, o); }
function _asyncToGenerator(n) { return function () { var t = this, e = arguments; return new Promise(function (r, o) { var a = n.apply(t, e); function _next(n) { asyncGeneratorStep(a, r, o, _next, _throw, "next", n); } function _throw(n) { asyncGeneratorStep(a, r, o, _next, _throw, "throw", n); } _next(void 0); }); }; }
var stripe = Stripe('pk_test_51Pe7kpRxdmX4TkLvnNStsqKMI0UjKhPalcYyXTzcfhgU8jdDnDS2RfLGzlfR7k6lTc0jjFTgP58cAszI0ilYfcEP00w0Bs2tOZ');
...
},{"./alerts":"alerts.js"}],"../../node_modules/regenerator-runtime/runtime.js":[function(require,module,exports) {
var define;
/**
...
var _updatingUserData = require("./updatingUserData");
...
document.addEventListener('DOMContentLoaded', function () {
  var signUpBtn = document.getElementById('sign__btn');
  var loginBgc = document.querySelector(".login__bgc");
  var userMessage = document.querySelector('.user__meassage');
  var loginForm = document.querySelector('.signin__form');
  var logoutBtn = document.querySelector('.nav__el--logout');
  var submitBtn = document.querySelector('.form-user-data');
  var savePassword = document.querySelector('.form-user-settings');
  var signUpForm = document.getElementById('signUp__form');
  var resetPasswordBtn = document.getElementById('reset');
  var newPasswordForm = document.querySelector('.new-password-form');
  var bookingBtn = document.getElementById('bookTour');
  var isSignUp = true;
  ...
  function getTokenFromUrl() {
    ...
    console.log(parts);
    var token = parts[4].split('?')[0]; // Get the last part which should be the 
    console.log(token);
    return token;
  }
  if (signUpBtn) {
    signUpBtn.addEventListener('click', function (e) {
      ...
      if (isSignUp) {
        ...
        userMessage.innerHTML = _content;
        isSignUp = true;
      }
    });
  }
  ...
  if (newPasswordForm) {
    ...
    newPasswordForm.addEventListener('submit', function (e) {
      ...
      var passwordConfirm = document.getElementById('newPassConf').value;
      (0, _login.newPassword)(password, passwordConfirm, token);
    });
  }
  if (submitBtn) {
    submitBtn.addEventListener('submit', function (e) {
      ...
      (0, _updatingUserData.updateData)(form);
    });
  }
  if (savePassword) {
    console.log('password');
    savePassword.addEventListener('submit', function (e) {
      e.preventDefault();
      var passwordCurrent = document.getElementById('password-current').value;
      var password = document.getElementById('password').value;
      var passwordConfirm = document.getElementById('password-confirm').value;
      (0, _updatingUserData.updatePassword)(passwordCurrent, password, passwordConfirm);
    });
  }
  if (bookingBtn) {
